...
/**
 * Projection DTO for the {@link org.activityinfo.server.database.hibernate.entity.Site} domain object, including
 * its {@link org.activityinfo.server.database.hibernate.entity.Location Location}, and
 * {@link org.activityinfo.server.database.hibernate.entity.ReportingPeriod ReportingPeriod} totals
 *
 * @author Alex Bertram
 */
public final class SiteDTO extends BaseModelData implements EntityDTO, HasAdminEntityValues {
     ...
     * See {@link org.activityinfo.server.database.hibernate.entity.Location#getName()}
     * 
